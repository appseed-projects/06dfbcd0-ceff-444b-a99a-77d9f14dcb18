...
- Timestamp: `2022-06-14 16:26`
- Build ID: `06dfbcd0-ceff-444b-a99a-77d9f14dcb18`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/06dfbcd0-ceff-444b-a99a-77d9f14dcb18.git
$ cd 06dfbcd0-ceff-444b-a99a-77d9f14dcb18
```
